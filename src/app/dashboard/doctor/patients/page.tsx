...
import { Search, User, Calendar, Users, Activity, AlertTriangle, Eye, Filter, CheckCircle2, Banknote } from "lucide-react"
    ...
    <div className="space-y-6 p-8 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 rounded-[50px]">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[10px] uppercase tracking-[0.25em] text-slate-500 font-medium">Doctor Portal / Patient Registry</p>
        </div>
                    ...
                    <TableRow key={patient.patient_id} className="hover:bg-slate-50/80 border-b border-slate-100 transition-colors">
                      ...
                      <TableCell className="text-right py-4">
                        <div className="flex justify-end gap-2">
                          <Link href={`/dashboard/doctor/patients/${patient.patient_id}?name=${encodeURIComponent(getPatientDisplayName(patient))}`}>
