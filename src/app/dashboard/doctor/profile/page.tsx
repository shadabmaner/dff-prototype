    ...
    return (
        <div className="space-y-8 pb-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-6">
                <div>
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight">Provider <span className="bg-gradient-to-r from-primary to-indigo-500 bg-clip-text text-transparent">Profile</span></h1>
                ...
                <div className="space-y-6">
                    <Card className="fresh-card-alt border-none shadow-[0_15px_30px_-10px_rgba(0,0,0,0.05)] rounded-[2rem] overflow-hidden bg-white">
                        <CardContent className="p-8 flex flex-col items-center text-center relative">
                            ...
                            <h2 className="text-xl font-black text-slate-900">Dr. Sarah Wilson</h2>
                            <p className="text-[12px] font-bold text-slate-400 uppercase tracking-widest mt-1 mb-4">Senior Endocrinologist</p>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="fresh-card-alt border-none shadow-[0_15px_30px_-10px_rgba(0,0,0,0.05)] rounded-[2rem] overflow-hidden bg-white">
                        <CardHeader className="p-8 border-b border-slate-50">
                            ...
                            <CardDescription className="text-xs font-medium text-slate-500">Update your basic profile details visible to patients.</CardDescription>
                        </CardHeader>
                            ...
                            <form className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input id="firstName" defaultValue="Sarah" className="h-11 rounded-xl bg-slate-50/50 border-slate-200" />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="lastName" className="text-[11px] font-bold uppercase tracking-widest text-slate-500">Last Name</Label>
                                        <Input id="lastName" defaultValue="Wilson" className="h-11 rounded-xl bg-slate-50/50 border-slate-200" />
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <Label htmlFor="email" className="text-[11px] font-bold uppercase tracking-widest text-slate-500">Email Address</Label>
                                        <Input id="email" type="email" defaultValue="dr.sarah.wilson@healthplus.com" className="h-11 rounded-xl bg-slate-50/50 border-slate-200" />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea id="bio" rows={4} defaultValue="Board-certified endocrinologist specializing in metabolic disorders, thyroid conditions, and diabetes management. Committed to holistic patient care and evidence-based treatments." className="rounded-xl bg-slate-50/50 border-slate-200 resize-none p-4" />
                                </div>
                            </form>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="fresh-card-alt border-none shadow-[0_15px_30px_-10px_rgba(0,0,0,0.05)] rounded-[2rem] overflow-hidden bg-white">
                        <CardHeader className="p-8 border-b border-slate-50 flex flex-row items-center justify-between">
                            <div>
                                <CardTitle className="text-lg font-black tracking-tight text-slate-900">Clinical Credentials</CardTitle>
                            ...
                            <form className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input id="specialty" defaultValue="Endocrinology" className="h-11 rounded-xl bg-slate-50/50 border-slate-200" />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="license" className="text-[11px] font-bold uppercase tracking-widest text-slate-500">Medical License Number</Label>
                                        <Input id="license" defaultValue="MED-8923-NY" className="h-11 rounded-xl bg-slate-50/50 border-slate-200" />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="education" className="text-[11px] font-bold uppercase tracking-widest text-slate-500">Education & Degrees</Label>
                                    <Input id="education" defaultValue="MD - Harvard Medical School, Residency - Johns Hopkins" className="h-11 rounded-xl bg-slate-50/50 border-slate-200" />
                                </div>
                            </form>
                        </CardContent>
                    </Card>
