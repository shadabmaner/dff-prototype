  ...
  return (
    <div className="flex flex-col h-full">
      <div className="border-b bg-white px-6 py-4">
        <div className="flex items-center gap-3">
          <Link href={`/dashboard/admin/collections/${collectionId}`}>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="bg-white border rounded-lg">
            <div className="p-4 border-b">
              <h2 className="font-semibold text-gray-900">Patient Progress Details</h2>
            ...
            {patients.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12">
                <p className="text-gray-500">No patients enrolled in this collection yet</p>
              </div>
            ) : (
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Journey Day</TableHead>
                    ...
                    {patients.map((patient) => (
                      <TableRow key={patient.patient_id}>
                        <TableCell className="font-medium">
                          ...
                          <p className="text-xs text-gray-500 mt-1">{patient.patient_id}</p>
                        </TableCell>
                        <TableCell>
          ...
          {patients.length > 0 && (
            <div className="bg-white border rounded-lg p-6">
              <h2 className="font-semibold text-gray-900 mb-4">Progress Distribution</h2>
