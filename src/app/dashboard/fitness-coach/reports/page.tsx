...
export default function FitnessCoachReportsPage() {
                ...
                <div className="relative z-10 flex flex-col gap-6">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <Badge variant="outline" className="rounded-xl border-white/10 bg-white/5 text-white/40 text-[8px] font-black uppercase tracking-[0.2em] px-3 py-1 shadow-inner">PERFORMANCE VAULT</Badge>
                        </div>
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-2.5">
                            ...
                            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-primary">Training Intelligence</p>
                        </div>
                        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white leading-tight">
                            Training <span className="bg-gradient-to-r from-primary via-blue-400 to-cyan-300 bg-clip-text text-transparent">Intelligence</span> Hub
                        </h1>
                        <p className="max-w-2xl text-sm text-slate-400 font-medium leading-relaxed">
                            Analyze performance patterns, review coaching findings, and finalize training sequences with high-fidelity visualization.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <Card className="fresh-card-alt border-none shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] rounded-[2.5rem] overflow-hidden bg-white">
                <CardHeader className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between p-8 border-b border-slate-100/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-[10px] uppercase font-black tracking-[0.2em] text-slate-400">Query patient performance vault signals.</CardDescription>
                        </div>
                    </div>
                    <div className="flex gap-2">
                ...
                <CardContent className="p-8 bg-slate-50/30">
                    <div className="relative mb-8">
                        ...
                        <Input
                            placeholder="Query by patient name, encrypted ID, or assessment type..."
                                ...
                                <CardContent className="p-8">
                                    ...
                                    <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100 group-hover:bg-white transition-all duration-300 mb-8 min-h-[100px] flex flex-col justify-center">
                                        <div className="flex items-center gap-2 mb-3 opacity-40">
                                            ...
                                            <span className="text-[9px] font-black uppercase tracking-widest">Coaching Findings</span>
                                        </div>
