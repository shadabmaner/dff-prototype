...
interface AssessmentSubmissionsCardProps {
  ...
  onSetSelectedAssessment: (assessment: any) => void;
}

export function AssessmentSubmissionsCard({ isLoadingPatient, assessmentSubmissions, onSetSelectedAssessment }: AssessmentSubmissionsCardProps) {
  return (
          ...
          <div className="space-y-4">
            {assessmentSubmissions.map((assessment: any) => (
              <div
                ...
                onClick={() => onSetSelectedAssessment(assessment)}
              >
