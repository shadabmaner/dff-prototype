...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    user_type: "sales",
    items: [
      { title: "Dashboard", href: "/dashboard/sales/dashboard", icon: LayoutDashboard },
      { title: "New Lead Management", href: "/dashboard/sales/leads", icon: Users },
      { title: "Welcome Call Management", href: "/dashboard/sales/welcome-calls", icon: PhoneCall },
      { title: "Payment Recovery", href: "/dashboard/sales/payment-recovery", icon: IndianRupee },
      { title: "Residential Camp Boosting", href: "/dashboard/sales/residential-camp", icon: Sparkles },
