...
interface DoctorAppointmentBookingDialogProps {
  open: boolean
...
export default function DoctorAppointmentBookingDialog({
  open,
  onOpenChange,
  patient,
  onSuccess,
}: DoctorAppointmentBookingDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[460px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Schedule an appointment for {getPatientDisplayName(patient)}
          </DialogDescription>
        </DialogHeader>
